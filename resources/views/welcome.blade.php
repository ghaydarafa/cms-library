...
<body class="flex flex-col min-h-screen text-white bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1671519821564-ced7e41ee7ae?q=80&w=1964&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');">

    <main class="flex-grow flex items-center justify-center">
        <div class="text-center bg-slate-800 p-8 rounded-lg max-w-md w-full flex flex-col items-center">
